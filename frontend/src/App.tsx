...
class Teams extends React.Component <{school: string; name: string; city: string; state: string;}> {
  render() {
    ...
    return (
      <div>
        ...
        <h2>City, State: {oneTeam.city}, {oneTeam.state}</h2>
      </div>
    );
  }
}
function PrintTeams() {
  return (
    <div>
    {TeamNames.map(oneTeam => <Teams {...oneTeam}/>)}
  </div>
    );
}
